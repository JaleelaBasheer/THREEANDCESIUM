...
import { DebugTilesRenderer as TilesRenderer, NONE,SCREEN_ERROR,GEOMETRIC_ERROR,DISTANCE,DEPTH,RELATIVE_DEPTH,IS_LEAF,RANDOM_COLOR } from '3d-tiles-renderer';
...
const init=() =>{
	...
	secondControls = new FlyControls( secondCamera, secondRenderer.domElement );
	...
	thirdPersonControls = new FlyControls( thirdPersonCamera, thirdPersonRenderer.domElement );
...
useEffect(() => {
    ...
    return () => {
        // Cleanup code
        if (renderer) {
            document.body.removeChild(renderer.domElement); // Remove renderer's DOM element from the body
